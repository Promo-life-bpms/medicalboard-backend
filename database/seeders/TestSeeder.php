...
class TestSeeder extends Seeder
{
    ...
    {
        $names = [ 
            'Adriana García Sifuentes',
            'Alfonso Mazatan Davila',
            'Angélica Gutiérrez Juárez',
            'Carlos Alberto Galindo Hernandez',
            'Carlos Alberto Melendrez Barrios',
            'Evaldo Jesús Rodríguez Mejía',
            'Francisco Ramírez Santa Rita',
            'Gabriela Delgadillo Peniche',
            'Gabriela López Arballo',
            'Gabriela Vicenta Santiago Soriano',
            'Gabriela Virginia Escudero Lourdes',
            'Gabriela Zarco Aguilar',
            'José Gamaliel Hernández Ochoa',
            'José Ignacio Alcántara Lomelí',
            'Juan Carlos Melendrez Gálvez',
            'Juan Francisco Aguilar Cañedo',
            'Juan Márquez Jiménez',
            'Julio César Salinas Elizondo',
            'Leticia Gabriela Colina Rubio',
            'Luis Gerardo Martínez Valadés',
            'Luis Mauricio Franco Hernández',
            'Mario Ángel Quiñones Peña',
            'Mario Gerardo Villarreal Padilla',
            'Martha Alicia Gaxiola Paredes',
            'Nalleli Alarcon Sanchez',
            'Octavio Rodrigo Martínez Pérez',
            'Pedro Pablo Galícia Herrera',
            'Rafael de Jesús Gallo Sandoval',
            'Reymundo Juárez Barraza',
            'Ricardo Arturo Martínez Orpinel',
            'Roberto Monteverde Ortiz',
            'Victor García Arano',
        ];
